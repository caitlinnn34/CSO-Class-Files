...
test_average = sum(test_scores) / float(len(midterm_score))
testFinalGrade = test_average * .30
print testFinalGrade

midterm_score = [85]
midterm_average = sum(midterm_score) / float(len(midterm_score))
midtermFinalGrade = midterm_average * .10
